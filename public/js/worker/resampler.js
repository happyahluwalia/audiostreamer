//https://github.com/chris-rudmin/Recorderjs
 ...
 var Resampler = function( config ){
  ...
  this.resampledRate = 16000;//Harpreet - Changed the sample rate from 44kHz to 16kHz config.resampledRate;
  this.lastSampleCache = [];
  console.log("The resample rate is ",this.resampledRate);
  console.log("The Number of channels is ",this.numberOfChannels);
